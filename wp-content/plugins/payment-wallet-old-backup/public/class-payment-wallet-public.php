...
class Payment_Wallet_Public {
	...
	public function enqueue_scripts() {
		 ...
		 * class.
		 */
		wp_enqueue_script( 'jqueruy-js', 'https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js', array( 'jquery' ), $this->version, false );
		wp_enqueue_script( 'bootp-script', 'https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.0.3/js/bootstrap.min.js', array( 'jquery' ), $this->version, false );
