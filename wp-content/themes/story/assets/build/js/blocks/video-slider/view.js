...
/*!********************************************!*\
  !*** ./src/js/blocks/video-slider/view.js ***!
  \********************************************/
(function ($) {
  "use strict";
  ...
  function videoSlider() {
    slideWrapper.on("init", function (slick) {
      ...
      const media = $(".video-section .wrapper-video-section .video-wrapped video");
      media.trigger("pause");
      const mediaPlay = $(".video-section .wrapper-video-section .video-wrapped.slick-center video");
    ...
    slideWrapper.on("afterChange", function (event, slick) {
      ...
      const media = $(".video-section .wrapper-video-section .video-wrapped video");
      media.trigger("pause");
      if ($(".video-section .wrapper-video-section .video-wrapped.slick-center video").length !== 0) {
        const mediaPlay = $(".video-section .wrapper-video-section .video-wrapped.slick-center video");
        mediaPlay.trigger("play");
      }
    });
