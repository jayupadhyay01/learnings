		...
		<Fragment>
			<InspectorControls>
				...
				>
					...
					<div className="setting-row">
						<label htmlFor="background-gradient">
							<strong>
								{ __(
									'Steps Card Background Gradient',
									'anitian'
								) }
							</strong>
						</label>
							...
							gradients={ [
								{
									name: 'Yellow',
									gradient:
										'linear-gradient(106deg, rgba(226,167,72,1) 25%, rgba(252,232,103,1) 50%, rgba(226,167,72,1) 75%)',
					...
					<div className="setting-row">
						<label htmlFor="background-gradient">
							<strong>
								{ __(
									'Steps Active Card Background Gradient',
									'anitian'
								) }
							</strong>
						</label>
							...
							gradients={ [
								{
									name: 'Yellow',
									gradient:
										'linear-gradient(70deg, rgba(226,167,72,1) 25%, rgba(252,232,103,1) 50%, rgba(226,167,72,1) 75%)',
									slug: 'yellow-asteroid',
								},
								{
									name: 'Yellow Active',
									gradient:
										'linear-gradient(106deg, rgb(252, 228, 99) 31%, rgb(248, 187, 55) 85%)',
									slug: 'yellow-active',
								},
								{
									name: 'Black Radial',
				...
				>
					...
					<div className="setting-row">
						<ToggleControl
							label={ __( 'Card Buttons Visiblity' ) }
											...
											<>
												<div className="show-items-hover-wrap">
													...
													>
														...
														<div className="active-card-edit">
															<ToggleControl
																label={ __(
																	'Card Active'
																) }
