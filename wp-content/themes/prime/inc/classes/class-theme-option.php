...
class Theme_Option {
	...
	public function add_option_menu() {
		add_menu_page( 'Theme Options', 'Theme Options', 'manage_options', 'md-prime', array( $this, 'option_form' ), '', 50 );
	}
	...
	public function option_form() {
		?>
		<div class="wrap">
			<div class="md-prime-theme-options">
				<div class="md-prime-theme-options-header">
					<h1>MD Prime Theme Options</h1>
					<?php
					...
					<h2 class="nav-tab-wrapper">
						<a href="?page=md-prime&tab=general_options" class="nav-tab <?php echo esc_attr( 'general_options' === $active_tab ? 'nav-tab-active' : '' ); ?>"><?php echo esc_html__( 'General Settings', 'md-prime' ); ?></a>
					</h2>
	...
	public function option_settings_init() {
		...
		add_settings_section( 'md-prime-section', __( 'General Settings', 'md-prime' ), '__return_empty_string', 'md-prime' );
		add_settings_field(
			'md_prime_logo',
	...
	public function theme_option_assets() {
		...
		// Register styles.
		wp_register_style( 'theme-option-css', MD_PRIME_BUILD_CSS_URI . '/themeoption.css', array(), filemtime( MD_PRIME_BUILD_CSS_DIR_PATH . '/themeoption.css' ), 'all' );
		...
		wp_register_script( 'theme-option-js', MD_PRIME_BUILD_JS_URI . '/themeoption.js', array( 'jquery', 'wp-color-picker' ), filemtime( MD_PRIME_BUILD_JS_DIR_PATH . '/themeoption.js' ), true );
