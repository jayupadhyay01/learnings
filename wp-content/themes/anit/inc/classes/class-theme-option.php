...
class Theme_Option {
	...
	public function add_option_menu() {
		add_menu_page( 'Theme Options', 'Theme Options', 'manage_options', 'anitian', array( $this, 'option_form' ), '', 50 );
	}
	...
	public function option_form() {
		?>
		<div class="wrap">
			<div class="anitian-theme-options">
				<div class="anitian-theme-options-header">
					<h1>anitian Theme Options</h1>
					<?php
					...
					<h2 class="nav-tab-wrapper">
						<a href="?page=anitian&tab=general_options" class="nav-tab <?php echo esc_attr( 'general_options' === $active_tab ? 'nav-tab-active' : '' ); ?>"><?php echo esc_html__( 'General Settings', 'anitian' ); ?></a>
					</h2>
					<span><?php settings_errors(); ?></span>
				</div>
				<form action='options.php' enctype="multipart/form-data" method='post'> 
					<?php
					settings_fields( 'anitian-setting' );
					do_settings_sections( 'anitian' );
					submit_button();
					?>
				</form>
			</div>
	...
	public function option_settings_init() {
		register_setting( 'anitian-setting', 'anitian_settings' );
		add_settings_section( 'anitian-section', __( 'General Settings', 'anitian' ), '__return_empty_string', 'anitian' );
		add_settings_field(
			'anitian_logo',
			__( 'Site Logo:', 'anitian' ),
			array( $this, 'add_field' ),
			'anitian',
			'anitian-section',
			array(
				'type'  => 'file',
				'name'  => 'anitian_settings[anitian_img]',
				'value' => 'anitian_img',
			)
		);
		add_settings_field(
			'anitian_favicon',
			__( 'Site Favicon:', 'anitian' ),
			array( $this, 'add_field' ),
			'anitian',
			'anitian-section',
			array(
				'type'  => 'file',
				'name'  => 'anitian_settings[anitian_favicon]',
				'value' => 'anitian_favicon',
			)
		);
		add_settings_field(
			'anitian_tagline',
			__( 'Site Tagline:', 'anitian' ),
			array( $this, 'add_field' ),
			'anitian',
			'anitian-section',
			array(
				'type'  => 'text',
				'name'  => 'anitian_settings[anitian_tagline]',
				'value' => 'anitian_tagline',
			)
		);
		add_settings_field(
			'anitian_google_analytic',
			__( 'Google Analytic:', 'anitian' ),
			array( $this, 'add_field' ),
			'anitian',
			'anitian-section',
			array(
				'type'  => 'textarea',
				'name'  => 'anitian_settings[anitian_google_analytic]',
				'value' => 'anitian_google_analytic',
			)
		);
		add_settings_field(
			'anitian_css_code',
			__( 'Additional CSS:', 'anitian' ),
			array( $this, 'add_field' ),
			'anitian',
			'anitian-section',
			array(
				'type'  => 'textarea',
				'name'  => 'anitian_settings[anitian_css_code]',
				'value' => 'anitian_css_code',
			)
		);
		add_settings_field(
			'anitian_html_code',
			__( 'Additional html:', 'anitian' ),
			array( $this, 'add_field' ),
			'anitian',
			'anitian-section',
			array(
				'type'  => 'textarea',
				'name'  => 'anitian_settings[anitian_html_code]',
				'value' => 'anitian_html_code',
			)
		);
		add_settings_field(
			'anitian_color_picker',
			__( 'Color:', 'anitian' ),
			array( $this, 'add_field' ),
			'anitian',
			'anitian-section',
			array(
				'type'  => 'color-picker',
				'name'  => 'anitian_settings[anitian_color_picker]',
				'value' => 'anitian_color_picker',
			)
		);
		add_settings_field(
			'anitian_wysiwyg',
			__( 'Text Editor:', 'anitian' ),
			array( $this, 'add_field' ),
			'anitian',
			'anitian-section',
			array(
				'type'  => 'wysiwyg',
				'name'  => 'anitian_settings[anitian_wysiwyg]',
				'value' => 'anitian_wysiwyg',
			)
		);
		add_settings_field(
			'anitian_password',
			__( 'Manage Password:', 'anitian' ),
			array( $this, 'add_field' ),
			'anitian',
			'anitian-section',
			array(
				'type'  => 'password',
				'name'  => 'anitian_settings[anitian_password]',
				'id'    => 'password',
				'value' => 'anitian_password',
			)
		);
		add_settings_field(
			'anitian_selectbox',
			__( 'Select Option:', 'anitian' ),
			array( $this, 'add_field' ),
			'anitian',
			'anitian-section',
			array(
				'type'    => 'select',
				'name'    => 'anitian_settings[anitian_selectbox]',
				'value'   => 'anitian_selectbox',
				'options' => array(
					'0' => '0',
					'1' => '1',
					'2' => '2',
		...
		add_settings_field(
			'anitian_multiselect',
			__( 'Select Multiple Option:', 'anitian' ),
			array( $this, 'add_field' ),
			'anitian',
			'anitian-section',
			array(
				'type'    => 'multicheck',
				'name'    => 'anitian_settings[anitian_multiselect]',
				'id'      => 'multicheck',
				'value'   => 'anitian_multiselect',
				'options' => array(
					'0' => 'pizza',
					'1' => 'biryani',
					'2' => 'burger',
		...
		add_settings_field(
			'anitian_radio',
			__( 'Select Radio Option:', 'anitian' ),
			array( $this, 'add_field' ),
			'anitian',
			'anitian-section',
			array(
				'type'    => 'radio',
				'name'    => 'anitian_settings[anitian_radio]',
				'value'   => 'anitian_radio',
				'options' => array(
					'0' => 'HTML',
					'1' => 'CSS',
		...
		add_settings_field(
			'anitian_checkbox',
			__( 'Select Checkbox Option:', 'anitian' ),
			array( $this, 'add_field' ),
			'anitian',
			'anitian-section',
			array(
				'type'  => 'checkbox',
				'id'    => 'checkbox',
				'name'  => 'anitian_settings[anitian_checkbox]',
				'value' => 'anitian_checkbox',
		...
		add_settings_field(
			...
			array(
				'type'  => 'number',
				'name'  => 'anitian_settings[anitian_number]',
				'value' => 'anitian_number',
			)
		);
	}
	...
	public function add_field( array $args ) {
		$options = get_option( 'anitian_settings' );
		switch ( $args['type'] ) {
			case 'text':
	...
	public function file_callback( $args, $options ) {
		...
		<img class="anitian_img" 
			...
			?>
		/>
		<input class="anitian_img_url" 
			type="hidden" 
			name="<?php echo esc_attr( $args['name'] ); ?>" 
			size="60" 
			value="<?php echo isset( $options[ $args['value'] ] ) ? esc_attr( $options[ $args['value'] ] ) : ''; ?>"
		>
		<a href="#" class="anitian_img_upload"><button>Upload</button></a>
		<a href="#" class="anitian_img_remove"><button>Remove</button></a>
		<?php
	}
	...
	public function theme_option_assets() {
		...
		// Register styles.
		wp_register_style( 'theme-option-css', ANITIAN_BUILD_URI . '/themeoption.css', array(), filemtime( ANITIAN_BUILD_PATH . '/themeoption.css' ), 'all' );
		...
		wp_register_script( 'theme-option-js', ANITIAN_BUILD_URI . '/themeoption.js', array( 'jquery', 'wp-color-picker' ), filemtime( ANITIAN_BUILD_PATH . '/themeoption.js' ), true );
